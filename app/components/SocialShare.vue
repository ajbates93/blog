<template>
  <div class="social-share mb-8">
    <h3 class="text-lg font-semibold text-white mb-4 text-center">Share this post</h3>
    <div class="flex flex-wrap gap-3 justify-center">
      <!-- Twitter/X -->
      <button
        @click="shareOnTwitter"
        class="flex items-center gap-2 px-4 py-2 bg-[#4278ba] hover:cursor-pointer text-[#2b2b2b] rounded-lg transition-all duration-200"
      >
